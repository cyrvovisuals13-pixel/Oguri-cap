...
export default {
    ...
    execute: async({ Oguri, m, prefix, command, commands }) => {
        if (m.args.length >= 1) {
            let data = []
            ...
            let teks = `Hajimemashite! @${m.sender.split("@")[0]}, Oguri Cap siap membantu,Ini Adalah Daftar Perintah Yang Tersedia\n\n`
            ...
            Oguri.sendMessage(m.from, 'https://i.pinimg.com/736x/a0/c4/2d/a0c42d730933395915418f8e5698c5ed.jpg', {
                caption: teks,
                quoted: m,
                mentions: Oguri.parseMention(teks),
                extra: {
                    ctwaContext: {
                        title: Oguri.info.pushname,
                        sourceUrl: 'https://www.instagram.com/_noir.ofc?igsh=MXhoandpazVjNnIxeg==',
                        thumbnail: (await Func.getFile('https://i.pinimg.com/736x/a0/c4/2d/a0c42d730933395915418f8e5698c5ed.jpg')).data.toString('base64'),
                        mediaType: 1
                    }
                }
            })
